  ...
  return (
    <div className="flex">
      ...
      <div className="bg-white  hidden md:flex flex-col w-[18%] h-screen  p-5 space-y-4 fixed">
        ...
        className={
        isOpen
          ? `md:w-[18%] bg-purple-500-500 md:border md:border-black/10 md:h-screen md:fixed md:overflow-y-auto md:scrollbar-hide 
   flex-col fixed top-0 left-0 w-full gap-0 md:bg-fuchsia-500 `
          : ""
      }
