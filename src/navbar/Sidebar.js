    ...
    <div className="sidebar">
      ...
      <div className="container">
        ...
        <div className="mb-4">
          <div className="subheadergroup">
            <span style={{ color: "#00000066" }} className="subheadergroup1">
              Favorites
            </span>
            <span style={{ color: "#00000033" }} className="subheadergroup2">
              Recent
            </span>
          </div>
          <div>
      ...
      <div className="container">
        ...
        <div className="space-y-2">
          <div className="menu">
            <GoDotFill className="custom-icon" />
            <img src="../Image/overview.png" alt="overview" />
            <span>Overview</span>
          </div>
          <div className="menu">
            <LiaAngleRightSolid className="custom-icon" />
            <img src="../Image/usermanagem.png" alt="usermanagem" />
            <span>User Mgmt</span>
          </div>
          <div className="menu">
            <LiaAngleRightSolid className="custom-icon" />
            <img src="../Image/listing.png" alt="listing" />
            <span>Listings</span>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        ...
        <div className="mt-4 space-y-2">
          <div className="menu">
            <LiaAngleRightSolid className="custom-icon" />
            <img src="../Image/acct.png" alt="acct" />
            <span>Account</span>
          </div>
          <div className="menu">
            <LiaAngleRightSolid className="custom-icon" />
            <img src="../Image/cooperate.png" alt="cooperate" />
            <span>Corporate</span>
          </div>
          <div className="menu">
            <LiaAngleRightSolid className="custom-icon" />
      ...
      >
        <img src="../Image/Group 15 1.png" alt="Prelura" />
        <div>
          <p>Prelura 2025</p>
        </div>
      </div>
